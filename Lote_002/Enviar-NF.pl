...
my $Cliente = 'Bertini - NF | '.DataHora();
my $Pacote = DataHora()."-NF.zip";
...
# SMTP, E-MAIL, TITULO, ARQUIVO
	...
	my $DEFAULT_RECIPIENT = 'amanda.bertinimadeiras@hotmail.com,clau.bertinimadeiras@hotmail.com,ailtonzsilva@gmail.com';
